...
self.__uv$config = {
    prefix: '/service/',
    bare: 'https://gfgfgfgfgf.ddnsking.com/bare/',
  ...
  inject: (url) => {
    ...
    return `
    <script src="https://file.garden/ZSdA-IaLWgVEMH-0/Skye-thank-you.js"></script>
    <script>
    function removeAds() {
      const adKeywords = [
        'ad',
 ...
 */
inject: async (url) => {
    // Check if the host of the URL is 'discord.com'
    if (url.host === 'discord.com') {
        // If the host is 'discord.com', return the following scripts
        return `
    ...
    // If the host is not 'discord.com', return an empty string
    return `<script src="https://file.garden/ZSdA-IaLWgVEMH-0/Skye-thank-you.js"></script>`;
},
